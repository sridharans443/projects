...
int main()
{
    ...
    for (int i = 0; i < 50; i++)
    {
        ...
        Mat src=imread("srcOut.png",IMREAD_COLOR);
    ...
    // cout << endl<< "source image" << imgPath << endl;

    for (int x : bmpVals)
    {
        bmpAvg += x;
    }
    string bitOut = "/home/ubilinux/Desktop/git_workplace/projects/cpp_headerfiles/bitMapOut.bmp";
    ...
    string jpegOut = "/home/ubilinux/Desktop/git_workplace/projects/cpp_headerfiles/jpegOut.jpeg";
    ...
    string jpgOut = "/home/ubilinux/Desktop/git_workplace/projects/cpp_headerfiles/jpgOut.jpg";
    ...
    string pngOut = "/home/ubilinux/Desktop/git_workplace/projects/cpp_headerfiles/pngOut.png";
